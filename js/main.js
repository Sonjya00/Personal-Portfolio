const projects = [
  ...
  },
  {
    ...
    url: "https://github.com/Sonjya00/MyReads_React",
    description:
      "A book tracking app that allows users to search books using an API and categorize them within 3 custom shelves.",
    alt: "MyReads React App"
  },
  {
    id: 7,
    ...
    description:
      "A fully responsive and accessible app that fetches and displays a series of data related to restaurants, which can be filtered by neighborhood and cuisine",
  ...
  },
  {
    ...
    description:
      "An arcade game built with JavaScript object-oriented programming features to create player, enemies, collectibles and obstacles on a dynamic canvas",
    alt: "Frogger Game"
  },
  {
    id: 5,
    ...
    description:
      "A fully responsive memory game with animations, a score board and a timer",
    alt: "Matching Game"
  },
  {
    id: 4,
    ...
    description:
      "A game that creates a canvas of a custom size and allows to make drawings by coloring the cells with custom colors",
  ...
  // },
  {
    ...
    description:
      "An app that gives the user a funny random message and allows him/her to share it via Twitter",
